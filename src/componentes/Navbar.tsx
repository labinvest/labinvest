            ...
            {menuOpen && (
                <div className="absolute top-full left-0 right-0 bg-white shadow-md rounded-b-md md:hidden z-40 mx-4">
                    <nav className="flex flex-col p-4 space-y-2 text-gray-700" aria-label="Menu de navegação mobile">
                        ...
                        <hr className="my-2" />
                        <button onClick={() => router.push("/perfil")} aria-label="Ir para Meu Perfil" className="text-left px-3 py-2 rounded hover:bg-gray-100 cursor-pointer">Meu Perfil</button>
                        <button onClick={() => router.push("/agendamento")} aria-label="Ir para Meus Agendamentos" className="text-left px-3 py-2 rounded hover:bg-gray-100 cursor-pointer">Meus Agendamentos</button>
                        <button onClick={() => router.push("/")} aria-label="Sair da conta" className="text-left px-3 py-2 rounded hover:bg-gray-100 cursor-pointer text-red-600">Sair</button>
                    </nav>
                </div>
            )}
        </header>
